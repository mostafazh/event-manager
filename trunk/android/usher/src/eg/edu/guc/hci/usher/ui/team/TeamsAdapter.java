...
class TeamsAdapter extends ArrayAdapter<TeamMember> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate(eg.edu.guc.hci.usher.ui.R.layout.team_member_item, null);
        }
        TeamMember o = items.get(position);
        if (o != null) {
            TextView member_name = (TextView) v.findViewById(eg.edu.guc.hci.usher.ui.R.id.teamMemberItemName);
            TextView member_position = (TextView) v.findViewById(eg.edu.guc.hci.usher.ui.R.id.teamMemberItemType);
            if (member_name != null) {
                member_name.setText(o.getName());
            }
            if (member_position != null) {
                member_position.setText(o.getName());
            }
